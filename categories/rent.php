...
<!-- Termina head, importaciones, etc -->
  ...
  <body>
    ...
    <section class="ftco-search">
    	<div class="container">
	    	<div class="row">
					<div class="col-md-12 search-wrap">
						...
						<form name="frmSearch" method="post" action="rent" class="search-property">
	        		<div class="row">
		...
		<small style="margin-left: 7rem;">*Todos los precios son por mes</small>
		<?php
			...
			if(isset($_POST['ubicacion'], $_POST['ordenfecha'], $_POST['tipo'], $_POST['preciomax']))
			{
				...
				WHERE ubicacion = :uubicacion AND vrenta = :uvrenta AND pr_int < :uprecio AND autorizada = 'Si' AND vendido = 'No' ORDER BY fecha $ordenfecha");
			...
			else
			{
				...
				FROM propiedades
				RIGHT JOIN fotos ON propiedades.id = fotos.id_property
				WHERE vrenta = 'renta' AND autorizada = 'Si' AND vendido = 'No'");
				$select_smt->execute();
