      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Departamentos</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-search">
    	<div class="container">
	    	<div class="row">
					<div class="col-md-12 search-wrap">
						...
						<form name="frmSearch" method="post" action="depart" class="search-property">
	        		<div class="row">
		...
		<?php
			...
			if(isset($_POST['ubicacion'], $_POST['ordenfecha'], $_POST['tipo'], $_POST['preciomax']))
			{
				...
				WHERE ubicacion = :uubicacion AND vrenta = :uvrenta AND pr_int < :uprecio AND categoria = 'Departamento' AND autorizada = 'Si' AND vendido = 'No' ORDER BY fecha $ordenfecha");
			...
			else
			{
				...
				FROM propiedades
				RIGHT JOIN fotos ON propiedades.id = fotos.id_property
				WHERE categoria = 'Departamento' AND autorizada = 'Si' AND vendido = 'No'");
				$select_smt->execute();
