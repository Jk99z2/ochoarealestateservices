    ...
    <section class="ftco-search">
    	<div class="container">
	    	<div class="row">
					<div class="col-md-12 search-wrap">
						...
						<form name="frmSearch" method="post" action="houses" class="search-property">
	        		<div class="row">
		...
		<?php
			...
			if(isset($_POST['ubicacion'], $_POST['ordenfecha'], $_POST['tipo'], $_POST['preciomax']))
			{
				...
				WHERE ubicacion = :uubicacion AND vrenta = :uvrenta AND pr_int < :uprecio AND categoria = 'Casa' AND autorizada = 'Si' AND vendido = 'No' ORDER BY fecha $ordenfecha");
			...
			else
			{
				...
				FROM propiedades
				RIGHT JOIN fotos ON propiedades.id = fotos.id_property
				WHERE categoria = 'Casa' AND autorizada = 'Si' AND vendido = 'No'");
				$select_smt->execute();
