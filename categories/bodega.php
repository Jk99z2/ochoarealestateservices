    ...
    <section class="ftco-search">
		...
		<?php
			...
			if(isset($_POST['ubicacion'], $_POST['ordenfecha'], $_POST['tipo'], $_POST['preciomax']))
			{
				...
				WHERE ubicacion = :uubicacion AND vrenta = :uvrenta AND pr_int < :uprecio AND categoria = 'Bodega' AND autorizada = 'Si' AND vendido = 'No' ORDER BY fecha $ordenfecha");
			...
			else
			{
				...
				FROM propiedades
				RIGHT JOIN fotos ON propiedades.id = fotos.id_property
				WHERE categoria = 'Bodega' AND autorizada = 'Si' AND vendido = 'No'");
				$select_smt->execute();
